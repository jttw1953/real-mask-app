...
await jest.unstable_mockModule('../../src/supabase_api/supabase_api.ts', mockSupabaseApi);
...
describe('POST /api/create-user', () => {
    ...
    describe('Validation Tests - Missing Fields', () => {
        ...
        test('should return 400 when missing all fields', async () => {
            const response = await request(app)
                ...
                .send({})
                .expect(400);
            expect(response.body.error).toBe('Missing required fields: full_name, email, password');
        });
        /**
    ...
    describe('Success Cases', () => {
        ...
        test('should create user successfully with valid data', async () => {
            ...
            expect(createUser).toHaveBeenCalledWith('John Doe', 'test@example.com', 'password123');
        });
        /**
    ...
    describe('Error Cases from Database', () => {
        ...
        test('should return 500 for unexpected errors', async () => {
            createUser.mockRejectedValue(new Error('Unexpected error'));
            const response = await request(app)
                .post('/api/create-user')
                .send({
                full_name: 'John Doe',
...
//# sourceMappingURL=create_user.test.js.map